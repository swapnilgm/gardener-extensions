...
func DefaultPredicates(mgr manager.Manager) []predicate.Predicate {
	return []predicate.Predicate{
		...
		//TODO: Do we need force deletion? extensionscontroller.AnnotationsChangedPredicate(),
	}
}
...
func add(mgr manager.Manager, options controller.Options, predicates []predicate.Predicate) error {
	...
	if err := ctrl.Watch(&source.Kind{Type: &extensionsv1alpha1.BackupEntry{}}, &handler.EnqueueRequestForObject{}, predicates...); err != nil {
		return err
	}
