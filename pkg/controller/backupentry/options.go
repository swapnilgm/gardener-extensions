...
const (
	// DeletionGracePeriodDaysFlag is the name of the command line flag to specify number
	// of days for deletion grace period.
	DeletionGracePeriodDaysFlag = "deletion-grace-period-days"
)
...
func (c *ReconcilerOptions) AddFlags(fs *pflag.FlagSet) {
	fs.Int64Var(&c.DeletionGracePeriodDays, DeletionGracePeriodDaysFlag, c.DeletionGracePeriodDays, "Number of days after which BackupEntry deletion should be triggered.")
}

// Complete implements Completer.Complete.
func (c *ReconcilerOptions) Complete() error {
	c.config = &ReconcilerConfig{&c.DeletionGracePeriodDays}
	return nil
}
...
func (c *ReconcilerConfig) Apply(deletionGracePeriod *int64) {
	*deletionGracePeriod = *c.DeletionGracePeriodDays
}
